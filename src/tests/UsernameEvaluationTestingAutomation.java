...
public class UsernameEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(1, "Aa_15678", true);

		performTestCase(2, "Gh", false);

		performTestCase(3, "TYgh965_F-H", true);
		
		performTestCase(4, "A--GIU", false);
		
		performTestCase(5, "-_.GHKJ", false);
