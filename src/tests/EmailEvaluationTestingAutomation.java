...
public class EmailEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(1, "asdf@gmail.com", true);
		...
		performTestCase(4, "Z@", false);
		
		performTestCase(5, "A@gmail.com", true);
		
		performTestCase(6, "A@", false);
		
		performTestCase(7, "@gmail.com", false);
	...
	private static void performTestCase(int testCase, String inputText, boolean expectedPass) {
		...
		String resultText= EmailValidator.checkForValidEmail(inputText);
